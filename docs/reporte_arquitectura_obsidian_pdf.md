...
**Por Eduardo García y Emilia Hernández**
...
- Arquitectura en MacOS
  - El pipeline se ejecuta en arquitectura ARM64 (Apple Silicon).
  - CPU Apple M3 Pro, 12 núcleos.
  - GPU integrada Apple (M3 Pro GPU) con aceleración por hardware (Metal).
  - 18 GiB de RAM.
